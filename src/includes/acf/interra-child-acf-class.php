...
acf_add_local_field_group(array(
	'key' => 'group_5d028ebde232a',
	'title' => 'SMTP Configuration',
	'fields' => array(
		array(
			'key' => 'field_5d028f0b44eea',
			'label' => 'SMTP Server',
			'name' => 'smtp_server',
			'type' => 'text',
			'instructions' => 'The SMTP Server address must match the domain associated with the email set in SMTP Email. For example if the SMTP Email is careers@interrarealty.com, then the SMTP Server must be interrarealty.com.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			'key' => 'field_5d028ed644ee8',
			'label' => 'SMTP Email',
			'name' => 'smtp_email',
			'type' => 'email',
			'instructions' => 'This email address will also be used as the \'from\' address for all email notifications.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
